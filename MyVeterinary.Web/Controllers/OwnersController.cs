...
using MyVeterinary.Web.Helpers;
using MyVeterinary.Web.Models;

namespace MyVeterinary.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var userCreated = await _userHelper.GetUserByEmailAsync(model.Username);
                    await _userHelper.AddUserToRoleAsync(userCreated, "Customer");
